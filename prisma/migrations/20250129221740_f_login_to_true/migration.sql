...
INSERT INTO "new_Admin" ("address", "cpf", "createdAt", "email", "first_name", "id", "isFirstLogin", "is_active", "last_name", "password", "phone", "registration_date", "role", "updatedAt") SELECT "address", "cpf", "createdAt", "email", "first_name", "id", "isFirstLogin", "is_active", "last_name", "password", "phone", "registration_date", "role", "updatedAt" FROM "Admin";
DROP TABLE "Admin";
...
INSERT INTO "new_Comercial" ("address", "cpf", "createdAt", "email", "first_name", "id", "isFirstLogin", "is_active", "last_name", "password", "phone", "registration_date", "role", "updatedAt") SELECT "address", "cpf", "createdAt", "email", "first_name", "id", "isFirstLogin", "is_active", "last_name", "password", "phone", "registration_date", "role", "updatedAt" FROM "Comercial";
